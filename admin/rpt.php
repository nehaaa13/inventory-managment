                        ...
                        <div class="row">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="row">
                                        ...
                                        <div class="table-responsive table-hover">
                                            <table class="table time2" id="">
                                                ...
                                                <tr class="totalLine">
                                                    ...
                                                    <td>
                                                        <input type="text" class="time-field fw-bold" id="top9" name="top9"
                                                            required readonly>
                                                    </td>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <td><input type="text" class="fw-bold" id=""  name="utm_total"
                                                            value='<?php echo $utmTotal; ?>' readonly></td>
                                                    <td><input type="text" class="fw-bold" id="" name="top2"
                                    ...
                                    <div class="col-md-4">
                                        <div class="table-responsive table-hover time2">
                                            <table class="table">
                                    ...
                                    <table class="table table-bordered table-hover" id="data-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number" name="width" class="form-control" min="3000" max="3500">
                                                </td>
...
if (isset($_POST['submit'])) {
    ...
    $manual_date2 = mysqli_real_escape_string($config, $_POST['date']);
    ...
    $sql2 = "INSERT INTO prod2 (manual_date, type, jumbo, scrap, gross, width, put, power_fail, elec, mech, process_req, plan_shutdown, other, ns_put, speed)
            VALUES ('$manual_date2', '$type', '$jumbo', '$scrap', '$gross', '$width', '$put', '$power_fail', '$elec', '$mech', '$process_req', '$plan_shutdown', '$other', '$ns_put', '$speed')";
